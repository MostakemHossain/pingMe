...
const Login = () => {
  ...
  const handleDemoFill = () => {
    setValue("email", import.meta.env.VITE_DEMO_LOGIN);
      ...
      <div className="hidden md:flex w-1/2 bg-gradient-to-br from-teal-500 to-emerald-600 items-center justify-center">
        <div className="text-center px-8">
          ...
          <h1 className="text-4xl font-extrabold text-white mb-2">
            Welcome Back to PingMe
          </h1>
          <p className="text-white/90 text-lg">
            Log in to connect with friends, chat in communities, and stay
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center p-6 bg-gray-50 min-h-screen">
        <div className="w-full max-w-md relative">
          ...
          <button
            ...
            className="absolute top-3 right-3 text-gray-400 hover:text-emerald-600 text-lg font-bold"
            title="Show demo login"
          >
            ?
          </button>
            ...
            <CardContent>
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                ...
                <Button
                  ...
                  className="w-full bg-gradient-to-r from-teal-500 to-emerald-600 hover:from-teal-600 hover:to-emerald-700 text-white py-3 rounded-xl transition-all duration-200 disabled:opacity-50"
                >
                ...
                {showDemo && (
                  <Button
                    ...
                    className="w-full bg-green-600 hover:bg-green-700 text-white py-3 rounded-xl transition-all duration-200 mt-2"
                  >
